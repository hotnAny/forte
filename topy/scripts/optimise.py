...
# XAC
def main(argv):
    # **obselete** argv[0] path to topy
    # argv[1] path to tpd file
    # argv[2] type of query
    # argv[3] gradient (for the user-guided tecnique)
    ...
    t.slope = 32
    print '[xac] slope is ', t.slope
    t.gradient = 0.1 if len(argv) < 4 else argv[3]
    print '[xac] gradient is ', t.gradient
